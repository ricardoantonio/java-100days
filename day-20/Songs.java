...
public class Songs {
    public List<Song> getSongs() {
        return List.of(
                ...
                new Song("I am not a woman, I'm a god", "Halsey", "Alternative Rock", 2021, 348),
                new Song("Pasos de cero", "Pablo Alborán", "Latin", 20214, 117),
                new Song("Smooth", "Santana", "Latin", 1999, 244),
                new Song("Immigrant Song", "Led Zeppelin", "Rock", 1970, 848)
        );
    }
}